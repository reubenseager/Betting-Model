...
def webscraping_epl_data_function(first_season, last_season, reread_data = False, s3_bucket_name = "epl-prediction-model-data"):
    ...
    #Year Variables
    earliest_year = first_season
    latest_year = last_season
    #latest_year = 2024
